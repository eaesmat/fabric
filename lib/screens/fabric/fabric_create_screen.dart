...
class FabricCreateScreen extends StatefulWidget {
  const FabricCreateScreen({super.key});

  @override
  State<FabricCreateScreen> createState() => _FabricCreateScreenState();
}

class _FabricCreateScreenState extends State<FabricCreateScreen> {
...
// controller class provider
    ...
    return Scaffold(
      appBar: AppBar(
        title: const LocaleTexts(localeText: 'create_fabric'),
        centerTitle: true,
      ),
