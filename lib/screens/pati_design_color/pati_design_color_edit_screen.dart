...
class PatiDesignColorEditScreen extends StatefulWidget {
  final Data drawData;
  final int drawId;
  const PatiDesignColorEditScreen(
      {super.key, required this.drawData, required this.drawId});

  @override
  State<PatiDesignColorEditScreen> createState() => _PatiDesignColorEditScreenState();
}

class _PatiDesignColorEditScreenState extends State<PatiDesignColorEditScreen> {
