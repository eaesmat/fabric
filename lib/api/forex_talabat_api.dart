...
class ForexTalabatApiServiceProvider {
// base url comes from constant/ api url
  final String _baseURL = baseURL;
  // Data type comes from its model
  // api EndPoint comes from controller
  Future<Either<String, List<Data>>> getForexTalabat(String apiEndpoint) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final forexTalabat = ForexTalabatModel.fromJson(jsonResponse);
