  ...
  Future<Either<String, List<Data>>> getFabric(String apiEndpoint) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final fabric = FabricModel.fromJson(jsonResponse);
...
// l or left returns failure error or status code
  ...
  Future<Either<String, int>> createFabric(
  ...
  Future<Either<String, int>> editFabric(
      String apiEndpoint, Map<String, dynamic> data) async {
    String jsonData = json.encode(data);
    try {
      final response = await http
  ...
  Future<Either<String, int>> deleteFabric(String apiEndpoint) async {
    try {
