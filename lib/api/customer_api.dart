...
class CustomerApiServiceProvider {
  ...
  Future<Either<String, List<Data>>> getCustomer(String apiEndpoint) async {
    try {
  ...
  Future<Either<String, int>> createCustomer(
  ...
  Future<Either<String, int>> editCustomer(
      String apiEndpoint, Map<String, dynamic> data) async {
    String jsonData = json.encode(data);
    try {
      final response = await http
  ...
  Future<Either<String, int>> deleteCustomer(String apiEndpoint) async {
    try {
