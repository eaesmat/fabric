...
class SaraiInDealApiServiceProvider {
  final String _baseURL = baseURL;

  Future<Either<String, List<Data>>> getSaraiInDeal(String apiEndpoint) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final draw = SaraiInDealModel.fromJson(jsonResponse);
  ...
  Future<Either<String, int>> createSaraiInDeal(
  ...
  Future<Either<String, int>> editSaraiInDeal(
      String apiEndpoint, Map<String, dynamic> data) async {
    String jsonData = json.encode(data);
    try {
      final response = await http
  ...
  Future<Either<String, int>> deleteSaraiInDeal(String apiEndpoint) async {
    try {
