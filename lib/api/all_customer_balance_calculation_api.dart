...
import 'package:fabricproject/model/all_customer_balance_calculation_model.dart';
import 'package:fpdart/fpdart.dart';
import 'package:http/http.dart' as http;

// this class is providing company api calls
class AllCustomerBalanceCalculationApiServiceProvider {
  ...
  Future<Either<String, Data>> getAllCustomerBalanceCalculation(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final allCustomerBalanceCalculation =
            AllCustomerBalanceCalculationModel.fromJson(jsonResponse);
// return data to the controller
        return right(
          allCustomerBalanceCalculation.data!,
        );
      } else {
