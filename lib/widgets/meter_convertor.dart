...
class MeterConvertor extends StatefulWidget {
  const MeterConvertor({super.key});

  @override
  State<MeterConvertor> createState() => _MeterConvertorState();
}

class _MeterConvertorState extends State<MeterConvertor> {
          ...
          children: [
            Expanded(
              child: GestureDetector(
                ...
                child: CustomTextFieldWithController(
                  isDisabled: true,
                  controller: fabricPurchaseController.dollarPriceController,
                  iconBtn: const Icon(
                    size: 30,
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: CustomTextFieldWithController(
                  isDisabled: true,
                  controller: fabricPurchaseController.yenPriceController,
                  iconBtn: const Icon(
                    size: 30,
                    Icons.add_box_rounded,
                    color: Pallete.blueColor,
        ...
        Row(
          children: [
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.amountOfMetersController,
            ...
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.amountOfWarsController,
        ...
        Row(
          children: [
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.totalDollarPriceController,
            ...
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.totalYenPriceController,
        ...
        Row(
          children: [
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.exchangeRateController,
            ...
            Expanded(
              child: CustomTextFieldWithController(
                isDisabled: true,
                controller: fabricPurchaseController.ttCommissionController,
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFieldWithController(
                    lblText: const LocaleText('meter'),
                    controller:
                        fabricPurchaseController.amountOfMetersController,
  ...
  void _postDataToController() {
    final fabricPurchaseController =
        Provider.of<FabricPurchaseController>(context, listen: false);
    fabricPurchaseController.amountOfMetersController.text =
        meterValue.toStringAsFixed(2);
    fabricPurchaseController.yenPriceController.text =
        yenPriceValue.toStringAsFixed(2);
    fabricPurchaseController.exchangeRateController.text =
        exchangeRateValue.toStringAsFixed(2);
    fabricPurchaseController.totalYenPriceController.text =
        totalYenPriceValue.toStringAsFixed(2);
    fabricPurchaseController.totalDollarPriceController.text =
        totalDollarPriceValue.toStringAsFixed(2);
    fabricPurchaseController.dollarPriceController.text =
        dollarPriceValue.toStringAsFixed(2);
    fabricPurchaseController.amountOfWarsController.text =
        varValue.toStringAsFixed(2);
    fabricPurchaseController.ttCommissionController.text =
